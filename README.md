...
**5,958 pump.fun token calls**, each with the market cap we called it at, the peak it reached
...
|---|---|
| Calls | 5,958 |
| Period | 2026-06-30 → 2026-08-31 |
| Median market cap at call time | **$11,630** |
| Reached 2x | 36.4% |
| Reached 3x | 22.6% |
| Reached 5x | 11.8% |
| Reached 10x | 5.1% |
| Reached 100x | 0.3% |
| Median peak | 1.61x |
| Largest | CATE — called at $21,077, peaked **4,520x** |
