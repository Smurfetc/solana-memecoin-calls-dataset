...
**3,911 pump.fun token calls**, each with the market cap we called it at, the peak it reached
...
|---|---|
| Calls | 3,911 |
| Period | 2026-06-30 → 2026-08-13 |
| Median market cap at call time | **$10,808** |
| Reached 2x | 38.8% |
| Reached 3x | 23.7% |
| Reached 5x | 12.3% |
| Reached 10x | 5.3% |
