...
**4,898 pump.fun token calls**, each with the market cap we called it at, the peak it reached
...
|---|---|
| Calls | 4,898 |
| Period | 2026-06-30 → 2026-08-22 |
| Median market cap at call time | **$11,005** |
| Reached 2x | 38.9% |
| Reached 3x | 23.9% |
| Reached 5x | 12.4% |
| Reached 10x | 5.2% |
