...
**4,265 pump.fun token calls**, each with the market cap we called it at, the peak it reached
...
|---|---|
| Calls | 4,265 |
| Period | 2026-06-30 → 2026-08-16 |
| Median market cap at call time | **$10,866** |
| Reached 2x | 38.8% |
| Reached 3x | 24.1% |
| Reached 5x | 12.5% |
| Reached 10x | 5.4% |
