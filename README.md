...
**4,786 pump.fun token calls**, each with the market cap we called it at, the peak it reached
...
|---|---|
| Calls | 4,786 |
| Period | 2026-06-30 → 2026-08-21 |
| Median market cap at call time | **$10,963** |
| Reached 2x | 38.9% |
| Reached 3x | 23.8% |
| Reached 5x | 12.3% |
| Reached 10x | 5.2% |
