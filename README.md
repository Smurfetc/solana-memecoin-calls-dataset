...
**3,775 pump.fun token calls**, each with the market cap we called it at, the peak it reached
...
|---|---|
| Calls | 3,775 |
| Period | 2026-06-30 → 2026-08-12 |
| Median market cap at call time | **$10,781** |
| Reached 2x | 39.1% |
| Reached 3x | 23.8% |
| Reached 5x | 12.5% |
| Reached 10x | 5.3% |
